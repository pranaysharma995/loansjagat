  ...
  components: {
	...
	data(){
		return{
			...
			no_to_words:'',
			no_to_words_salary:'',
			no_to_words_registry:'',
			no_to_words_existing_emi:'',
			no_to_words_co_applicant_emi:'',
			no_to_words_gross_anual_income:'',
	...
	methods: {
		convertNumberToWords(amount,type) {
			...
			if(type==1){
				...
				this.no_to_words_registry = words_string
			}else if(type==4){
				this.no_to_words_existing_emi = words_string
			}else if(type==5){
				this.no_to_words_co_applicant_emi = words_string
			}else if(type==6){
				this.no_to_words_gross_anual_income = words_string
			}else{
		...
		update(){
			...
			const addData = {
				...
				type_of_business_industry:this.type_of_busi,
		...
		axios.put('/home-loans-for-self-employed/'+this.data_id, addData)
			.then((response) => {
				console.log(response);
				this.$router.push({ name: 'hml_employee_result', 
									params: { 
												id: this.data_id, 
												loan_amount_required:this.loan_amount,
											}})
		...
		create(){
			...
			axios.post('/home-loans-for-self-employed/', addData)
				.then((response) => {
					console.log(response);
					this.data_id = response.data.id
					this.sehl_step_1 = false
					this.mob_otp = true
					//this.sentOtp()
					// this.showStep(2)
					//this.$router.push('/inward')
		...
		showStep(id){
			if(id==1){
				$('#sehl1').addClass('active');
				$('#sehl2').removeClass('active');
				$('#sehl3').removeClass('active');
				$('#sehl4').removeClass('active');
				this.sehl_step_1 = true
				this.sehl_step_2 = false
				this.sehl_step_3 = false
				this.sehl_step_4 = false
			}
			if(id==2){
				$('#sehl2').addClass('active');
				$('#sehl1').removeClass('active');
				$('#sehl3').removeClass('active');
				$('#sehl4').removeClass('active');
				this.sehl_step_2 = true
				this.sehl_step_1 = false
				this.sehl_step_3 = false
				this.sehl_step_4 = false
			}
			if(id==3){
				...
				$('#sehl3').addClass('active');
				$('#sehl1').removeClass('active');
				$('#sehl2').removeClass('active');
				$('#sehl4').removeClass('active');

				this.sehl_step_3 = true
				this.sehl_step_1 = false
				this.sehl_step_2 = false
				this.sehl_step_4 = false
			}
			if(id==4){
				...
				$('#sehl4').addClass('active');
				$('#sehl1').removeClass('active');
				$('#sehl2').removeClass('active');
				$('#sehl3').removeClass('active');

				this.sehl_step_4 = true
				this.sehl_step_1 = false
				this.sehl_step_2 = false
				this.sehl_step_3 = false
			}
