    ...
    <div>
		...
		<div class="container">
			...
			<div class="plresultHeadings">
				<h1>Congratulations! You Are Eligible for Home Loan Offers</h1>
		...
		<div class="container">
			<div class="filterResultBox" id="resultFilterBox2">
				...
				<div class="filterResultPrice">
					...
					<vue-range-slider ref="slider" :clickable="false" :step="100000" :min="min" :max="max" @slide-end="startDrag()" @drag-end="filterSliderBankData()" v-model="value"></vue-range-slider>
				</div>
...
<script src = "./HomeLoanBankEmployedFilter.js"></script> 
<style>
