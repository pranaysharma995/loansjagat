    ...
    <div>
		...
		<div class="container">
			...
			<div class="plresultHeadings">
				<h1>Congratulations! You Are Eligible for Overdraft Loan Offers</h1>
		...
		<div class="container">
			<div class="filterResultBox" id="resultFilterBox2">
				...
				<div class="filterResultPrice">
					...
					<vue-range-slider ref="slider" :clickable="false"  :step="10000" :min="min" :max="max" @slide-end="startDrag()" @drag-end="filterSliderBankData()" v-model="value"></vue-range-slider>
				</div>
			...
			<div class="bankListMain">
				...
				<div v-show="bankListInner" class="bankListInner" v-for="item in banks" v-bind:key="item.id">
					...
					<!-- <div class="rsltTblListPLloanAmt"> <i class="fa fa-rupee"></i> {{formatNumber(data.loan_amount_required)}} </div> -->
...
<script src = "./BankFilterDod.js"></script> 
<style>
