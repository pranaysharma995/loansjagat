				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-12 formInnerRight">
					...
					<form action="" method="">
						<div class="formInnerRightFields">
							<div class="row" id="newshl_step1" v-show="step_1">
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="formInputFields newsalHL">
										...
										<input @focus="toggleBorder" class="form-control" v-model="loan_amount_required" id="loan_amount_required" @keyup="convertNumberToWords(loan_amount_required,1)" type="number" placeholder="Enter Require Loan Amount">
									...
									<div class="formInputFields newsalHL">
										...
										<typeahead @focus="toggleBorder"  :data = "cities" 
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="formInputFields newsalHL">
										...
										<select @focus="toggleBorder" class="form-control" id="turn_over" v-model="turn_over" name="">
									...
									<div class="formInputFields newsalHL">
										<label>Mobile</label>
										<input @focus="toggleBorder" class="form-control" id="mobile" v-model="mobile" type="number" placeholder="Enter Mobile No" onKeyPress="if(this.value.length==10) return false;">
									</div>	<!-- formInputFields -->
									<div class="formInputFields newsalHL">
							...
							<div class="row" id="newshl_step2" v-show="step_2">
								<div class="newshl_step2_content">
									...
									<div class="newshl_step2_otp_code">
										<div class="newshl_step2_otp_inputs">
											<input type="text" maxLength="1" size="1" min="0" max="9" pattern="[0-9]{1}" v-model="no_one" class="optinput1234" />
											<input type="text" maxLength="1" size="1" min="0" max="9" pattern="[0-9]{1}" v-model="no_two" class="optinput1234" />
											<input type="text" maxLength="1" size="1" min="0" max="9" pattern="[0-9]{1}" v-model="no_three" class="optinput1234" />
											<input type="text" maxLength="1" size="1" min="0" max="9" pattern="[0-9]{1}" v-model="no_four" class="optinput1234" />
											<div style="clear:both;"></div>
							...
							<div class="row" id="newshl_step3" v-show="step_3">
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									...
									<div class="formInputFields">
										...
										<input  @focus="toggleBorder" @keyup="convertNumberToWords(market_value_property,2)" class="form-control" id="market_value_property" type="number" v-model="market_value_property" placeholder="Enter Market Value of Property">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="formInputFields">
										...
										<select @focus="toggleBorder" id="property_occupied_status" class="form-control" name="" v-model="property_occupied_status">
											<option value="">Select Property </option>
							...
							<div class="row" id="newshl_step4" v-show="step_4">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="formInputFields">
										...
										<select @focus="toggleBorder" class="form-control" id="industry_type" name="" v-model="industry_type">
							...
							<div class="row" id="newshl_step5" v-show="step_5">
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="formInputFields">
										...
										<input @focus="toggleBorder" @keyup="convertNumberToWords(any_emi,3)" class="form-control" type="number" id="any_emi" v-model="any_emi" placeholder="Enter Existing EMI">
										<div class="numToWords" v-html="no_to_words_emi">adas</div>
									</div>	<!-- formInputFields -->
									<div class="formInputFields">
										<label>Co-applicant Annual Income</label>
										<input @focus="toggleBorder" @keyup="convertNumberToWords(co_applicant_annual_income,4)" class="form-control" id="co_applicant_annual_income" v-model="co_applicant_annual_income" type="number" placeholder="Enter Co-applicant Annual Income">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="formInputFields">
										...
										<input @focus="toggleBorder" @keyup="convertNumberToWords(gross_anual_income,5)" class="form-control" id="gross_anual_income" v-model="gross_anual_income" type="number" placeholder="Enter Gross Annual Income">
										<div class="numToWords" v-html="no_to_words_gross_income">adas</div>
									</div>	<!-- formInputFields -->
								</div>
	...
	<div class="contentMainDiv">
		...
		<div class="container">
			<div class="contentInnerDiv">
				<p><b>Get to Choose the Best Lender for your Dropline Overdraft Needs</b></p>
				...
				<p><b>Some key benefits of Dropline Overdraft?</b></p>
				<div class="contentList">
					<ul>
						<li class="tick">While Dropline Overdraft need collaterals. A Home Loan unlike these loans requires a person to have a decent credit profile against which credit is given.</li>
				...
				<h2 class="middleHeading" id="documentID">Dropline Overdraft - Documents Required</h2>	
				...
				<p><b>Self-Employed Professional often need following documents for a Dropline Overdraft</b></p>
				<div class="contentList">
					<ul>
				...
				<h2 class="middleHeading">Dropline Overdraft Specific FAQs</h2>	
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-11 col-md-11 col-sm-11 col-10">
								<p><b>What is the eligibility for Dropline Overdraft ?</b><br>
						...
						<div class="row">
							...
							<div class="col-lg-11 col-md-11 col-sm-11 col-10">
								<p><b>What are the different types of Dropline Overdraft ?</b><br>
						...
						<div class="row">
							...
							<div class="col-lg-11 col-md-11 col-sm-11 col-10">
								<p><b>How long does it take to get Dropline Overdraft ?</b><br>
						...
						<div class="row">
							...
							<div class="col-lg-11 col-md-11 col-sm-11 col-10">
								<p><b>What is the Dropline Overdraft amount one can avail ?</b><br>
						...
						<div class="row">
							...
							<div class="col-lg-11 col-md-11 col-sm-11 col-10">
								<p><b>What is the Tenure of Dropline Overdraft ?</b><br>
...
<script src = "./OverDraftLimit.js"></script> 
