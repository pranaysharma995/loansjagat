    ...
    <div>
		...
		<div class="container">
			...
			<div class="plresultHeadings">
				<h1>Congratulations! You Are Eligible for <span v-html="title">Personal Loan</span> Offers</h1>
		...
		<div class="container">
			<div class="filterResultBox" id="resultFilterBox2">
				...
				<div class="filterResultPrice">
					<p>Outstanding loan amt : <span class="rupeeIcon"></span> <span v-html="prce"> Lacs </span> + <span v-html="topup"> Lacs </span>  (Top Up Amt) <!--<span v-html="prce"> 10000</span>--> </p>
					<vue-range-slider ref="slider" :tooltip="false" :clickable="false" :step="10000" :min="min" :max="max" @slide-end="startDrag()" @drag-end="filterSliderBankData()" v-model="value"></vue-range-slider>
                    	
				</div>
				<div class="filterResultTenure">
					Tenure : <span v-html="tenurehtml">4</span> Years
					<vue-range-slider ref="slider" :clickable="false" :fixed="true"  @slide-end="tenureDrag()" :min="1" :max="tennure_max" @drag-end="filterSliderBankData()" v-model="tenure"></vue-range-slider>
			...
			<div class="rsltTableHeadPL" v-show="menu">
				...
				<div class="rsltTableHeadPLloanAmt">Outstanding Loan Amt</div>
				...
				<div class="rsltTableHeadPLtenure">Total Savings
					<a href="#" class="field-tip">
						<i class="fa fa-question-circle-o"></i>
			...
			<div class="bankListMain">
				...
				<div v-show="bankListInner" class="bankListInner" v-for="(item,index) in banks" v-bind:key="item.id">
					<div class="rsltTblListPLbank">
						...
						<i class="fa fa-rupee"></i> {{formatNumber(item.loan_amt)}}
						<span class="emiTopup">
							<i class="fa fa-level-up"></i> Topup Amt : <i class="fa fa-rupee"></i> {{item.topup_amt}}
						</span>
					...
					<div class="rsltTblListPLtenure" style="color: #20b126;font-size: 14px;font-weight: 600;">
						...
						<span class="emiTopup"><i class="fa fa-envira"></i> {{item.emi_reduction}} EMI Reductions</span>
					</div>
					<div class="rsltTblListPLaction">
						<a class="applyLink" @click="applyLoan(index)" href="javascript:void(0)">Apply&nbsp;&nbsp;<i class="fa fa-bolt"></i></a>
					</div>
				</div>
			</div>
		</div>
...
<script src = "./BalanceTransferResult.js"></script> 
<style>
