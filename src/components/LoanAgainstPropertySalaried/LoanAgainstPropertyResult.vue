    ...
    <div>
		...
		<div class="container">
			...
			<div class="plresultHeadings">
				<h1>Congratulations! You Are Eligible for Salaried LAP Offers</h1>
		...
		<div class="container">
			<div class="filterResultBox" id="resultFilterBox2">
				...
				<div class="filterResultPrice">
					...
					<vue-range-slider ref="slider" :clickable="false" :step="50000" :min="min" :max="max" @slide-end="startDrag()" @drag-end="filterSliderBankData()" v-model="value"></vue-range-slider>
				</div>
				<div class="filterResultTenure">
					Tenure : <span v-html="tenurehtml">4</span> Years
					<vue-range-slider ref="slider" :clickable="false" :fixed="true"  @slide-end="tenureDrag()" :min="5" :max="30" @drag-end="filterSliderBankData()" v-model="tenure"></vue-range-slider>
			...
			<div class="bankListMain">
				...
				<div v-show="bankListInner" class="bankListInner" v-for="item in banks" v-bind:key="item.id">
					...
					<div class="rsltTblListPLloanAmt"> <i class="fa fa-rupee"></i> {{formatNumber(data.required_loan_amount)}} </div>
...
<script src = "./LoanAgaistPropertyResult.js"></script> 
<style>
