      ...
      <div class="row mgb-60">
        <form>
          <div class="row">
            ...
            <div class="col-5 form-group">
              <label for="monthly-salary" class="color-white">Net Montly Salary*</label>
              <input
                type="text"
                class="form-control"
            ...
            <div class="col-12 form-group mgt-15">
              <router-link to="/self-employed/transaction-detail">
