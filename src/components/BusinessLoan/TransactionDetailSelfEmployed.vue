          ...
          <form v-on:submit.prevent="submit">
            <div class="row">
              <div class="col-md-5 col-sm-6 col-xs-12 form-group">
                <label for="gross-annual-income" class="color-white"
                ...
                <input
                  ...
                  :class="{
                    'is-invalid': validationStatus($v.grossAnnualIncome),
                  }"
                />

                <div
                  v-if="!$v.grossAnnualIncome.required"
              ...
              <div class="col-md-5 col-sm-6 col-xs-12 form-group">
                <label for="current-emi" class="color-white"
                  >Current EMI*</label
                >
                <input
                  type="text"
                ...
                />
                <div v-if="!$v.emi.required" class="invalid-feedback">
                  Current EMI is required.
                </div>
              </div>
              <div class="col-md-5 col-sm-6 col-xs-12 form-group">
                <label for="credit-score" class="color-white"
                  >Credit Score*</label
                >
                <select
                  name="creditScore"
              ...
              <div class="col-md-2 col-sm-12 col-xs-12 form-group"></div>
              <div class="col-md-5 col-sm-6 col-xs-12 form-group">
                <label for="business_type" class="color-white"
                  >Business Type*</label
                >
                <select
                  name="business_type"
                ...
                <div v-if="!$v.business_type.required" class="invalid-feedback">
                  Business Type required.
                </div>
              </div>
              <div class="col-md-5 col-sm-6 col-xs-12 form-group">
                <label for="industries_name" class="color-white"
                  >Industries Name*</label
                >
                <select
                  ...
                  :class="{
                    'is-invalid': validationStatus($v.industries_name),
                  }"
                >
                ...
                <div
                  v-if="!$v.industries_name.required"
                  class="invalid-feedback"
                >
              ...
              <div class="col-md-2 col-sm-12 col-xs-12 form-group"></div>
              <div class="col-md-5 col-sm-6 col-xs-12 form-group">
                <label for="industries_item" class="color-white"
                  >Industries Item*</label
                >
                <select
                  name="industries_item"
                  v-model="industries_item"
                  id="industries_item"
                  class="form-control"
                  v-model-trim="industries_item"
                  :class="{
                    'is-invalid': validationStatus($v.industries_item),
                  }"
                >
                  <option value="">Select Industry</option>
                ...
                <div
                  v-if="!$v.industries_item.required"
                  class="invalid-feedback"
                >
                  Industries Item required.
                </div>
              </div>
...
export default {
  ...
  mounted() {
    this.getIndustries();
    this.grossAnnualIncome = localStorage.getItem("gross_annual_income")
      ? localStorage.getItem("gross_annual_income")
      : null;
    this.creditScore = localStorage.getItem("civil_score")
      ? localStorage.getItem("civil_score")
      : "below-650";
    this.emi = localStorage.getItem("any_loans_running_emi_monthly")
      ? localStorage.getItem("any_loans_running_emi_monthly")
      : null;
    this.gst = localStorage.getItem("gst") ? localStorage.getItem("gst") : "No";
    this.business_type = localStorage.getItem("business_type")
      ? localStorage.getItem("business_type")
      : "Trader";
    this.business_type = localStorage.getItem("type_of_business_industry")
      ? localStorage.getItem("type_of_business_industry")
      : "Trader";
    this.industries_name = localStorage.getItem("industry_type")
      ? localStorage.getItem("industry_type")
      : null;
    this.industries_item = localStorage.getItem("industry_item")
      ? localStorage.getItem("industry_item")
      : null;
  },
  methods: {
    ...
    getIndustries: function () {
      ...
      axios
        .get(process.env.VUE_APP_LIVE_HOST + "/bl-margin-list")
        .then((response) => {
